@echo off
REM Batch script to save all KQL queries to Application Insights
REM This script calls the PowerShell script with your dev environment settings

echo 🚀 Saving KQL queries to Application Insights using dev environment...
echo.
...
powershell -ExecutionPolicy Bypass -File "save-queries-to-insights.ps1"
